...
public final class CartDao_Impl implements CartDao {
  ...
  public CartDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCartItem = new EntityInsertionAdapter<CartItem>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `cart_items` (`productId`,`name`,`price`,`imageUrl`,`unit`,`quantity`) VALUES (?,?,?,?,?,?)";
      }
  ...
  @Override
  public Object insertOrUpdate(final CartItem cartItem,
      ...
      public List<CartItem> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new CartItem(_tmpProductId,_tmpName,_tmpPrice,_tmpImageUrl,_tmpUnit,_tmpQuantity);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getCartItem(final int productId, final Continuation<? super CartItem> $completion) {
      ...
      public CartItem call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final int _tmpQuantity;
            _tmpQuantity = _cursor.getInt(_cursorIndexOfQuantity);
            _result = new CartItem(_tmpProductId,_tmpName,_tmpPrice,_tmpImageUrl,_tmpUnit,_tmpQuantity);
          } else {
            _result = null;
          }
          return _result;
